class Aventura {
  ...
  void dibujar() {
    ...
    case 9:
      ...
      dialogos.textoFuenteOld(".", width/2, 100, 255, 20, CENTER);
    ...
    case 25:
      ...
      // dialogos.textoFuenteOld(".", 0, 0, 255, 20, CENTER);
      dialogos.textoFuenteOld("¡Felicidades! Lograste esquivar los ataques del demonio fuego, \n Calcifer, pero aún así, este no es el camino correcto", width/2, height/2, 255, 30, CENTER);
    ...
    case 26:
      ...
      //Texto
      dialogos.textoFuenteOld(".", width/2, 100, 255, 80, CENTER);
      dialogos.textoFuenteVcr("El ingrediente misterioso", width/2, 100, 255, 20, CENTER);
